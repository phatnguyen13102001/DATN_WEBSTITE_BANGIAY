        ...
        a.each(this, function() {
            ...
            if (aG.is("ul") && aG.children("li").length && aG.find("img.etalage_source_image").length) {
                ...
                a.each(w, function(a1) {
                    ...
                    } else { if (!j.length && !a3.length) { a4.remove() } }
                ...
                if (c.smallthumbs_position === "left") { am = am + o + P } else { if (c.smallthumbs_position === "top") { aK = aK + aH + P } }
                ...
                if (c.show_icon) {
                    ...
                    if (c.smallthumbs_position === "left") { aw.left = o + P + parseInt(c.icon_offset, 10) } else { if (c.smallthumbs_position === "top") { aw.top += aH + P } }
                    E.css(aw)
                }
                ...
                if (c.smallthumbs_position === "left") { aw.left = "+=" + o + P } else { if (c.smallthumbs_position === "top") { aw.top = "+=" + aH + P } }
                aO.css(aw).hide();
                W.css({ width: T, height: a0 });
                aw = { margin: 0, opacity: 0 };
                if (c.align === "right" && s === "auto") { aw.left = -(T + (d * 2) + (J * 2) + aA) } else { if (s === "auto") { aw.left = aS + aA } }
                K.css(aw).hide();
                if (c.show_descriptions) {
                ...
                if (q > 1 || !c.smallthumb_hide_single) {
                    ...
                    if (aL > 0) { for (ad = 1; ad <= (y - 1); ad = ad + (aj - 1)) { ab = 1; for (ab; ab <= aL; ab += 1) { if (aF === "vert") { aV.eq(ad + ab - 1).css({ marginBottom: (P - 1) }) } else { aV.eq(ad + ab - 1).css({ marginRight: (P - 1) }) } } } } else {
                        if (aL < 0) {
                ...
                if (c.show_descriptions) { f = ap.attr("title"); if (f) { az.html(f).show() } }
                var D = function() {
                    if (t) {
                        clearInterval(t);
                        t = false
                ...
                var aW = function() {
                    ...
                    if (c.magnifier_invert) { ay.stop().animate({ opacity: 1 }, c.speed, function() { if (c.click_to_zoom) { A = false } }) }
                    clearTimeout(x);
                    if (aJ) { k() }
                };
                var g = function(a3, a1) {
                    ...
                    if (ao) { an.attr("src", ay.data("src")) }
                    aB.attr("src", ap.attr("src"));
                    if (c.show_descriptions) { f = ap.attr("title"); if (f) { az.html(f).show() } else { az.hide() } }
                    if (aJ) {
                        D();
                        k()
                    }
                ...
                var L = function() {
                    ...
                    if (!c.right_to_left) { i = aG.find(".etalage_smallthumb_active").prev(); if (!i.length) { if (q > aj) { F() } else { aV.last().trigger("click") } return true } } else {
                ...
                var au = function() {
                    var i;
                    if (c.magnifier_invert) { aG.find(".etalage_thumb_active").mouseleave() }
                    if (!c.right_to_left) { i = aG.find(".etalage_smallthumb_active").next(); if (!i.length) { if (q > aj) { ac() } else { aV.first().trigger("click") } return true } } else { i = aG.find(".etalage_smallthumb_active").prev(); if (!i.length) { if (q > aj) { F() } else { aV.last().trigger("click") } return true } }
                    i.trigger("click")
                };
                var n = function(a2) {
                ...
                var aI = function(i) { if (!c.click_callback(i, aR)) { return false } if (typeof etalage_click_callback === "function") { etalage_click_callback(i, aR); return false } return true };
                var ah = function(i) { if (c.change_callback(i, aR)) { if (typeof etalage_change_callback === "function") { etalage_change_callback(i, aR) } } };
                w.add(aO).add(E).mouseenter(function() { if (c.show_hint) { r.hide() } if (!c.click_to_zoom || A) { U() } }).mouseleave(function() { aW() });
                ...
                function aP(a2) {
                    ...
                    if (z) { if (a2 === "left") { a3.trigger("click") } else { j.trigger("click") } } else {
                                    ...
                                    if (a7.hasClass("etalage_smallthumb_last") && a7.next().length) { aP("right") } else {
                                        if (a7.hasClass("etalage_smallthumb_navtostart")) { ac() } else {
                                            if (z && !a(this).next().length) {
                                                F();
                                                return true
                                            } else { if (z && !a(this).prev().length) { ac(); return true } }
                                            g(a7, false)
                                        }
                                    }
                                }
                ...
                } else { aO.click(function() { var i = ay.data("anchor"); if (i) { if (aI(i)) { window.location = i } } }) }
                if (q > 1 && c.keyboard) {
                    a(document).keydown(function(i) {
                        if (i.keyCode === 39 || i.keyCode === "39") { if (!c.right_to_left) { au() } else { L() } }
