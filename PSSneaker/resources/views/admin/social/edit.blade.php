                    ...
                    <div class="upload-file">
                        ...
                        <label class="upload-file-label mb-2" for="file">
                            <div class="upload-file-image rounded mb-3">
                                <img class="rounded img-upload" onerror="this.src='http://localhost/TranVanTiep_742922W/thumbs/250x250x1/assets/images/noimage.png';" src="http://localhost/TranVanTiep_742922W/upload/photo/iconzalo-h-54671.png" alt="Alt Photo">
                            </div>
