...
<section class="content">
    ...
    <form class="validation-form" method="post" action="{{route('slideshow.store')}}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control text-sm" name="link" id="link" placeholder="Link" value="" required>
                </div>
                <div class="form-group">
